...
boneSelector.insert(5, RecordMultiBone.checkFor, RecordMultiBone)
boneSelector.insert(5, RecordSingleBone.checkFor, RecordSingleBone)
boneSelector.insert(5, checkForRecordBone, RecordViewBoneDelegate)
